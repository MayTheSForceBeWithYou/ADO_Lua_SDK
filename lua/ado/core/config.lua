--- core/config.lua — normalize and validate client configuration
-- Lives under ado.core so Neovim plugins that own require("ado.config") do not
-- shadow this module.
-- Depends on: none (errors used by callers of normalize)
...
function M.normalize(opts)
  ...
  -- Trim CR/LF (Windows .env), whitespace, and trailing slash
